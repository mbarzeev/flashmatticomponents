...
package com.flashmattic.flashmatticomponents.framework.wizard {
	 ...
	 */
	[Event(name="wizardComplete", type="com.flashmattic.flashmatticomponents.framework.wizard.WizardEvent")]
	 ...
	 *  @tiptext 	wizard complete event
	 */
	[Event(name="wizardCancel", type="com.flashmattic.flashmatticomponents.framework.wizard.WizardEvent")]
	 ...
	 *  @tiptext 	wizard complete event
	 */
	[Event(name="nextStep", type="com.flashmattic.flashmatticomponents.framework.wizard.WizardEvent")]
	 ...
	 *  @tiptext 	wizard complete event
	 */
	[Event(name="prevStep", type="com.flashmattic.flashmatticomponents.framework.wizard.WizardEvent")]
	...
	public class Wizard extends TitleWindow {
		...
		private function validateNextStep():void {
			...
			if (nextStepIndex >= steps.length) {
				_nextButton.label = ResourceManager.getInstance().getString("FlashmatticomponentsLabelsResourceBundle", "wizard.buttons.finish.label"); 
				// Set the summary string to the summary step text
				setSummaryContent();
			} else {
				_nextButton.label = ResourceManager.getInstance().getString("FlashmatticomponentsLabelsResourceBundle", "wizard.buttons.next.label");
